          ...
          <div className="mx-auto max-w-4xl">
            <div className="rounded-2xl bg-white p-6 shadow-sm md:p-8">
              ...
              <div className="mt-8 flex justify-end">
                <Link to={"/payment"}>
                  <button className="flex min-w-[120px] items-center justify-center rounded-full h-12 px-8 bg-indigo-600 text-white text-base font-bold leading-normal tracking-wide shadow-md shadow-indigo-500/20 transition-all duration-300 cursor-pointer hover:bg-indigo-700 focus:outline-none focus:ring-4 focus:ring-indigo-500/50">
